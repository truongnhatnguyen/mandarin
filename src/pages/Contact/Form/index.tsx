      ...
      <div className="">
        <div className="flex flex-col relative">
          ...
          <div className="flex justify-end mt-1">
            {showFullNameError && (
              <span className="text-orange-600 font-mono text-xs mr-4">
                Không được để trống, vui lòng nhập full name !
              </span>
            )}
          </div>
        ...
        <div className="flex flex-col relative">
          ...
          <div className="flex justify-end mt-1">
            {showEmailError && (
              <span className="text-orange-600 font-mono text-xs mr-4">
                Không được để trống, vui lòng nhập email !
              </span>
            )}
          </div>
          <div className="cs-height_20 cs-height_lg_20" />
        ...
        <div className="flex flex-col relative">
          ...
          <div className="flex justify-end mt-1">
            {showWrightSubjectError && (
              <span className="text-orange-600 font-mono text-xs mr-4">
                Không được để trống, vui lòng nhập wright Subject!
              </span>
            )}
          </div>
          <div className="cs-height_20 cs-height_lg_20" />
        ...
        <div className="flex flex-col relative">
          ...
          <div className="flex justify-end mt-1">
            {showMessageError && (
              <span className="text-orange-600 font-mono text-xs mr-4">
                Không được để trống, vui lòng nhập message !
              </span>
            )}
          </div>
          <div className="cs-height_20 cs-height_lg_20" />
