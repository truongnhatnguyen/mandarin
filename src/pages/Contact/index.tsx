     ...
     <div className="lg:col-span-8 mx-auto">
      <div className="cs-contact_card_wrap">
       <div className="cs-contact_card items-center">
        <Link to={ENV.telegram} className="cs-contact_info text-center ">
        ...
        <div className="cs-contact_info text-center">
         ...
         <p className="cs-contact_text">mandarinpowered.io@gmail.com</p>
        </div>
        <Link to={ENV.twitter} className="cs-contact_info text-center">
         <div className="cs-contact_icon">
          <svg
           xmlns="http://www.w3.org/2000/svg"
           width="31"
