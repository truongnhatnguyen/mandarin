      ...
      <div>
        ...
        <div className="container-auto">
          <div className="cs-section_heading cs-style4">
            <h2 className="cs-section_title">Connect Your Wallet</h2>
            <p className="cs-section_subtitle">
              Amet minim mollit non deserunt ullamco est sit aliqua dolor do{" "}
              <br /> amet sint. Velit officia consequat duis enim velit mollit.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-3 grid-cols-1 gap-x-4">
            <div className="">
              <div className="cs-iconbox cs-style3 cs-box_shadow cs-white_bg">
                <div className="cs-iconbox_img">
                  <img
                    src="../assets/img/general/iconbox_logo_1.svg"
                    alt="Logo"
                  />
                </div>
                <div className="cs-iconbox_text">
                  Convenient interaction on web browser, it enables users to
            ...
            <div className="">
              <div className="cs-iconbox cs-style3 cs-box_shadow cs-white_bg">
                <div className="cs-iconbox_img">
                  <img
                    src="../assets/img/general/iconbox_logo_2.svg"
                    alt="Logo"
                  />
                </div>
                <div className="cs-iconbox_text">
                  Allowing users to securely store various cryptocurrencies,
            ...
            <div className="">
              <div className="cs-iconbox cs-style3 cs-box_shadow cs-white_bg">
                <div className="cs-iconbox_img">
                  <img
                    src="../assets/img/general/iconbox_logo_3.svg"
                    alt="Logo"
                  />
                </div>
                <div className="cs-iconbox_text">
                  Trust Wallet is a mobile cryptocurrency wallet that allows
