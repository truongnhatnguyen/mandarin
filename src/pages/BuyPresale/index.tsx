      ...
      <div className="row">
       <div className="col-lg-8 offset-lg-2">
        <div className="cs-single_post">
         <T>
          Welcome to Mandarin, the leading online platform for purchasing games
          with DRI tokens!
         </T>{" "}
         <P>
         ...
         <P>
          With DRI tokens, you can easily and securely buy the games you want,
          while taking advantage of the benefits of using blockchain technology.{" "}
         </P>{" "}
         <P>
          Our website features a user-friendly interface that allows you to
          easily browse and search for the games you're interested in, while
          ensuring that your transactions are safe and your personal information
          is secure.{" "}
         </P>{" "}
         <P>
          At Mandarin, we prioritize customer satisfaction and strive to provide
          you with the best possible gaming experience.{" "}
         </P>{" "}
         <T>
          come and discover the benefits of purchasing games with DRI tokens on
          Mandarin today!
         </T>{" "}
        </div>
       </div>
